...
RpcHost = "127.0.0.1"
RpcPort = 9999
RpcPath = "/rpcapi" # you can change it
RpcAuthName = "X-Secret" # you should change it 
RpcToken = "change-your-token-here" # you should change it here


# dnslog config
DbLogName = "/full/path/to/your/burpblindlog.db" # ssrf scan log db
LengthMap = {"x":0, "a":1,  "b":2, "g":3, "p":4, "t":5, "m":6, "q":7, "h":8, "i":9} # dnslog 
ReverseLengthMap = {0:"x", 1:"a", 2:"b", 3:"g", 4:"p", 5:"t", 6:"m", 7:"q", 8:"h", 9:"i"}
WildFlag = "op"
API_DOMAIN_PREFIX = "api"+ReverseLengthMap[3]+""
DnslogAPIDOMAIN = API_DOMAIN_PREFIX +".yourdnslog.domain" # change to your dns domain
DnslogAPIURL = "/dnslogapi" # change
DnslogAuthName = "X-Change-to-whatever" # change
DnslogToken = "your dnssrflog token" #change
DnslogDOMAIN = "yourdnslog.domain" # change to your dns domain


#log2db config
Log2dbDbName = '/full/path/to/your/burplog2db.db'  # change to you log db path
